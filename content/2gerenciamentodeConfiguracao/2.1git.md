...
Para nossos testes utilizaremos o git, um derivado do kernel do Linux sendo atualmente a mais famosa ferramenta para versionamento e controle de código sendo utilizado em diversos projetos famosos, alguns deles podem ser conferidos abaixo:
